                ...
                child: Obx(
                  () => ListView.builder(
                    ...
                    itemBuilder: (BuildContext contex, int index) {
                      return InkWell(
                          onTap: () {
                            controller.HandleHeritageDetailsPage();
                          },
                          child: HeritageItem(
                              context,
                              controller.listHeritages[index].title ?? "",
                              controller.listHeritages[index].images[0],
                              controller.listHeritages[index].evaluation ??
                                  ""));
                    },
                  ),
                ),
