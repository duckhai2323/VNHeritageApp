...
class SignUpController extends GetxController {
  ...
  Future<void> CreateUserWithEmailAndPassword() async {
    try{
      await firebaseAuth.createUserWithEmailAndPassword(email: text2Controller.text.toString(), password: text3Controller.text.toString());
  ...
  Future<void> PushDataUser(BuildContext context) async {
    ...
    Get.toNamed(AppRoutes.APPLICATION,parameters: {'user_id':documentId, 'user_name':text1Controller.text.toString(),'user_image':'https://t4.ftcdn.net/jpg/05/49/98/39/360_F_549983970_bRCkYfk0P6PP5fKbMhZMIb07mCJ6esXL.jpg'});
  }
