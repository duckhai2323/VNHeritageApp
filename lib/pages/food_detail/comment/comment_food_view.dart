          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Obx(
                    () => controller.clickSelect.value
                        ? Container(
                            width: MediaQuery.of(context).size.width,
                            height:
                                controller.listImages.length <= 3 ? 120 : 240,
                            child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return ClipRRect(
                                    ...
                                    child: Image.file(
                                        File(controller.listImages[index].path),
                                        fit: BoxFit.cover));
                              },
                            ),
                          )
                        : InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(5),
                                border: Border.all(
                                    width: 1, color: AppColors.bottomNaviColor),
                              ),
                              child: const Center(
                                child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Hãy chia sẻ một chút về trải nghiệm của bạn...',
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: RichText(
                          text: const TextSpan(
                            text:
                                'Bằng việc đăng tải những hình ảnh này lên, tôi đã đọc và đồng ý với ',
                            style: TextStyle(
                              fontSize: 16,
                              color: AppColors.placeHolderColor,
                              fontWeight: FontWeight.w500,
