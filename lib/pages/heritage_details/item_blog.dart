...
class ItemBlogHeritageDetail extends GetView<HeritageDetailsController> {
  String image;
  String title;
  String user_image;
  String user_name;
  ...
  ItemBlogHeritageDetail(this.image, this.title, this.user_image, this.user_name, this.userLike);
